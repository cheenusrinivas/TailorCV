    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-6">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-10 w-full max-w-md text-center">
        ...
        >
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-3 border border-zinc-700 rounded-xl px-4 py-3 text-sm font-medium text-white hover:bg-zinc-800 transition-colors"
          >
